...
*******************************************************************************/
#ifndef __HYBOTICS_BMP180_UNIFIED_H__
#define __HYBOTICS_BMP180_UNIFIED_H__
...
class Hybotics_BMP180_Unified : public Adafruit_Sensor {
	public:
		Hybotics_BMP180_Unified (int32_t sensorID = -1);
