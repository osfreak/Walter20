...
*/
/**************************************************************************/
void Hybotics_LSM303DLHC_Accel_Unified::write8(byte address, byte reg, byte value) {
...
*/
/**************************************************************************/
byte Hybotics_LSM303DLHC_Accel_Unified::read8(byte address, byte reg) {
  byte value;
...
*/
/**************************************************************************/
void Hybotics_LSM303DLHC_Accel_Unified::read() {
...
*/
/**************************************************************************/
Hybotics_LSM303DLHC_Accel_Unified::Hybotics_LSM303DLHC_Accel_Unified(int32_t sensorID) {
  _sensorID = sensorID;
}
...
*/
/**************************************************************************/
bool Hybotics_LSM303DLHC_Accel_Unified::begin() {
  // Enable I2C
  Wire.begin();
...
*/
/**************************************************************************/
void Hybotics_LSM303DLHC_Accel_Unified::getEvent(sensors_event_t *event) {
  /* Clear the event */
...
*/
/**************************************************************************/
void Hybotics_LSM303DLHC_Accel_Unified::getSensor(sensor_t *sensor) {
...
*/
/**************************************************************************/
void Hybotics_LSM303DLHC_Mag_Unified::write8(byte address, byte reg, byte value) {
  Wire.beginTransmission(address);
  #if ARDUINO >= 100
    Wire.write((uint8_t)reg);
    Wire.write((uint8_t)value);
...
*/
/**************************************************************************/
byte Hybotics_LSM303DLHC_Mag_Unified::read8(byte address, byte reg) {
  byte value;
...
*/
/**************************************************************************/
void Hybotics_LSM303DLHC_Mag_Unified::read() {
...
*/
/**************************************************************************/
Hybotics_LSM303DLHC_Mag_Unified::Hybotics_LSM303DLHC_Mag_Unified(int32_t sensorID) {
  _sensorID = sensorID;
}
...
*/
/**************************************************************************/
void Hybotics_LSM303DLHC_Mag_Unified::getEvent(sensors_event_t *event) {
  /* Clear the event */
  memset(event, 0, sizeof(sensors_event_t));
...
*/
/**************************************************************************/
void Hybotics_LSM303DLHC_Mag_Unified::getSensor(sensor_t *sensor) {
  /* Clear the sensor_t object */
  memset(sensor, 0, sizeof(sensor_t));
