/******************************************************************************
	...
	Modified and renamed by Dale Weber, 09-Feb-2014
*******************************************************************************/
#if ARDUINO >= 100
 #include "Arduino.h"
#else
...
/**************************************************************************/
/*!
    @brief  Instantiates a new Hybotics_BMP180_Unified class
*/
/**************************************************************************/
Hybotics_BMP180_Unified::Hybotics_BMP180_Unified (int32_t sensorID) {
  _sensorID = sensorID;
}
...
*/
/**************************************************************************/
bool Hybotics_BMP180_Unified::begin (bmp180_mode_t mode) {
	//	Enable I2C
	Wire.begin();
...
*/
/**************************************************************************/
void Hybotics_BMP180_Unified::getPressure (float *pressure) {
...
*/
/**************************************************************************/
void Hybotics_BMP180_Unified::getTemperature (float *temp) {
...
*/
/**************************************************************************/
float Hybotics_BMP180_Unified::pressureToAltitude (float seaLevel, float atmospheric, float temp) {
	/*
	...
	*/
	...
	return (((float)pow((seaLevel / atmospheric), 0.190223F) - 1.0F) * (temp + 273.15F)) / 0.0065F;
}
...
*/
/**************************************************************************/
void Hybotics_BMP180_Unified::getSensor (sensor_t *sensor) {
...
*/
/**************************************************************************/
void Hybotics_BMP180_Unified::getEvent (sensors_event_t *event) {
	float pressure_kPa;
