/*
	NOTE: This is a fork of the Adafruit_BMP085 library, renamed Hybotics_BMP180_Unified
*/

#Adafruit Unified BMP180 Driver (Barometric Pressure Sensor) #

This driver is for the Adafruit BMP180 Breakout (http://www.adafruit.com/products/391), and is based on Adafruit's Unified Sensor Library (Adafruit_Sensor).
